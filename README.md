...
- The player's balance is currently just a set variable. Improvements can be made in the future to actually allow players to use real money. This would require a lot more in-depth testing towards profitability, however it would definitely make the game more captivating for users.
